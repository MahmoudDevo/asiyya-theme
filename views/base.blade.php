...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ in_array(app()->getLocale(), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) ? 'rtl' : 'ltr' }}">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{ asset('vendor/shop/themes/asiyya-theme/aimeos.css') }}" />
	...
	<body>
		...
		<script src="{{ asset('vendor/shop/themes/asiyya-theme/aimeos.js') }}"></script>
